def linux_targets = ['ubuntu.amd64', 'steam.amd64', 'maemo.armel', 'fedora.amd64', 'emscripten.wasm', 'emscripten.asmjs', 'android.armv8a.nougat.gles3', 'android.armv7a.nougat.gles2', 'android.armv7a.gingerbread.gles2', ]
...
void GetBuildStep(job, srcDir, platform, targetLabel, target)
{
    ...
    {
        cmd = "powershell \"${srcDir}\\ci\\appveyor-build.ps1\""
...
linux_targets.each {
    ...
    GetSourceStep(j, 'https://github.com/hbirchtree/coffeecutie-imgui.git', srcDir)
